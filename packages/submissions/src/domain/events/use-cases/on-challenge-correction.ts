...
import { MicroserviceTimeoutError } from './errors'
...
type OnChallengeCorrectionResponse = Either<
  MicroserviceTimeoutError | ZodError,
  { answer: Answer }
>
  ...
  async execute({
    ...
    try {
      ...
      if (err instanceof ZodError) {
        ...
        return failure(new Error(err.errors.toString()))
      }
      ...
      if (err instanceof TimeoutError) {
        ...
        return failure(new MicroserviceTimeoutError())
      }
